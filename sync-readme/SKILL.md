...
同步 README 文档与实际目录结构。当新增或删除技能/脚本时，自动更新 README.md、README.zh-CN.md 和 CLAUDE.md。
...
**Step 2: 对比 README 和 CLAUDE.md 中的目录结构**

读取以下三个文件的目录结构部分，提取当前记录的目录：
- `README.md` 的 `## Structure`
- `README.zh-CN.md` 的 `## 目录结构`
- `CLAUDE.md` 的 `## Structure`
...
- 每个脚本后添加简短注释说明用途
- `hooks/` 目录单独列出，不属于技能
- 保持三个文档（README.md、README.zh-CN.md、CLAUDE.md）同步
